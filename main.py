...
def main():
    ...
    #pipeline
    seg_model, classifier, label_to_name = load_pipeline(label_maps["num_classes"], device, manifest)
    predict_fn = make_predict_fn(seg_model, classifier, label_to_name, device)
